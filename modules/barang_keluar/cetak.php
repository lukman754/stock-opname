...
if ($stmt->rowCount() == 0) {
    echo "Data barang keluar tidak ditemukan!";
    exit;
}
...
<head>
    ...
    <title>Cetak Barang Keluar - <?php echo $barang_keluar['nomor_transaksi']; ?></title>
    <style>
        body {
...
<body>
    ...
    <div class="info">
        <div class="info-row">
            ...
            <div class="info-value">: <?php echo $barang_keluar['nomor_transaksi']; ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Tanggal</div>
            <div class="info-value">: <?php echo formatDate($barang_keluar['tanggal']); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Lokasi Asal</div>
            <div class="info-value">: <?php echo $barang_keluar['nama_lokasi']; ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Keterangan</div>
            <div class="info-value">: <?php echo $barang_keluar['keterangan'] ?: '-'; ?></div>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="signature">
            ...
            <p><?php echo $barang_keluar['nama_user']; ?></p>
        </div>
